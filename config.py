...
SQUARE_COLORS = {
    "light": "#F0D9B5",
    "dark": "#B58863",
    "highlight_best": QColor(20, 255, 20, 55), # Green for best move
    "highlight_alt": QColor(20, 20, 255, 55),   # Blue for alternate moves
    "highlight_last": QColor(255, 255, 0, 55) # Yellow for last move made (by OCR)
}
